...
def analyze_step_response(time_us, rc_command, output_signal, pid_loop_hz=400, plot=True, return_fit_curve=True):
    ...
    # Detect main step region: find largest change in input
    du = np.abs(np.diff(u))
    if du.size == 0:
