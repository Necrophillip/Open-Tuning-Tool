...
def _decode_blackbox_log(file_path):
    ...
    # Prefer system `blackbox_decode`, but fall back to a local copy bundled
    # in the project root (useful when the user hasn't installed it globally).
    project_root = os.path.abspath(os.path.join(os.path.dirname(__file__), '..', '..'))
    local_candidate = os.path.join(project_root, 'blackbox_decode')
